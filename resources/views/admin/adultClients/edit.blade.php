...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.adultClient.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.adult-clients.update", [$adultClient->id]) }}" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="form-group">
                    <label class="required" for="first_name">{{ trans('cruds.adultClient.fields.first_name') }}</label>
                    <input class="form-control {{ $errors->has('first_name') ? 'is-invalid' : '' }}" type="text" name="first_name" id="first_name" value="{{ old('first_name', $adultClient->first_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('last_name') ? 'is-invalid' : '' }}" type="text" name="last_name" id="last_name" value="{{ old('last_name', $adultClient->last_name) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="text" name="phone" id="phone" value="{{ old('phone', $adultClient->phone) }}">
                    @if($errors->has('phone'))
                        <div class="invalid-feedback">
                            {{ $errors->first('phone') }}
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('telephone') ? 'is-invalid' : '' }}" type="text" name="telephone" id="telephone" value="{{ old('telephone', $adultClient->telephone) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('province') ? 'is-invalid' : '' }}" name="province" id="province" required>
                        ...
                        @foreach(App\AdultClient::PROVINCE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('province', $adultClient->province) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('district') ? 'is-invalid' : '' }}" type="text" name="district" id="district" value="{{ old('district', $adultClient->district) }}" required>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('gender') ? 'is-invalid' : '' }}" name="gender" id="gender" required>
                        ...
                        @foreach(App\AdultClient::GENDER_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('gender', $adultClient->gender) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" name="age" id="age" required>
                        ...
                        @foreach(App\AdultClient::AGE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('age', $adultClient->age) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('age'))
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('medium') ? 'is-invalid' : '' }}" name="medium" id="medium" required>
                        ...
                        @foreach(App\AdultClient::MEDIUM_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('medium', $adultClient->medium) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('counselling_notes') ? 'is-invalid' : '' }}" name="counselling_notes" id="counselling_notes">{!! old('counselling_notes', $adultClient->counselling_notes) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status">
                        ...
                        @foreach(App\AdultClient::STATUS_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('status', $adultClient->status) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control ckeditor {{ $errors->has('incident_description') ? 'is-invalid' : '' }}" name="incident_description" id="incident_description">{!! old('incident_description', $adultClient->incident_description) !!}</textarea>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control datetime {{ $errors->has('follow_up') ? 'is-invalid' : '' }}" type="text" name="follow_up" id="follow_up" value="{{ old('follow_up', $adultClient->follow_up) }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('follow_up_phone') ? 'is-invalid' : '' }}" type="text" name="follow_up_phone" id="follow_up_phone" value="{{ old('follow_up_phone', $adultClient->follow_up_phone) }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('referred_to') ? 'is-invalid' : '' }}" name="referred_to" id="referred_to">
                        ...
                        @foreach(App\AdultClient::REFERRED_TO_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('referred_to', $adultClient->referred_to) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
