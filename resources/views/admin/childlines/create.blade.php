...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            {{ trans('global.create') }} {{ trans('cruds.childline.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route("admin.childlines.store") }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mother_first_name') ? 'is-invalid' : '' }}" type="text" name="mother_first_name" id="mother_first_name" value="{{ old('mother_first_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mother_last_name') ? 'is-invalid' : '' }}" type="text" name="mother_last_name" id="mother_last_name" value="{{ old('mother_last_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('mother_phone') ? 'is-invalid' : '' }}" type="text" name="mother_phone" id="mother_phone" value="{{ old('mother_phone', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_first_name') ? 'is-invalid' : '' }}" type="text" name="father_first_name" id="father_first_name" value="{{ old('father_first_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_last_name') ? 'is-invalid' : '' }}" type="text" name="father_last_name" id="father_last_name" value="{{ old('father_last_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('father_phone') ? 'is-invalid' : '' }}" type="text" name="father_phone" id="father_phone" value="{{ old('father_phone', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('guardian_first_name') ? 'is-invalid' : '' }}" type="text" name="guardian_first_name" id="guardian_first_name" value="{{ old('guardian_first_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('guardian_last_name') ? 'is-invalid' : '' }}" type="text" name="guardian_last_name" id="guardian_last_name" value="{{ old('guardian_last_name', '') }}">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control {{ $errors->has('age') ? 'is-invalid' : '' }}" name="age" id="age" required>
                        ...
                        @foreach(App\Childline::AGE_SELECT as $key => $label)
                            <option value="{{ $key }}" {{ old('age', '11-16') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                        @endforeach
                    </select>
                    @if($errors->has('age'))
                        <div class="invalid-feedback">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('referred_to_name') ? 'is-invalid' : '' }}" type="text"
                           name="referred_to_name" id="referred_to_name" value="{{ old('referred_to_name', '') }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('referred_to_contact') ? 'is-invalid' : '' }}" type="text"
                           name="referred_to_contact" id="referred_to_contact" value="{{ old('referred_to_contact', '') }}"
